...
const Wishlist = () => {
    ...
    useEffect(()=>{
        const book = JSON.parse(localStorage.getItem("booksWish")) || [];
    ...
    return (
        <div className=" w-full">
            {books.length === 0 ? (
                <div className="text-center my-10 text-2xl text-gray-500">No books have been added to the WishList :(</div>
            ) : (
                <div>
